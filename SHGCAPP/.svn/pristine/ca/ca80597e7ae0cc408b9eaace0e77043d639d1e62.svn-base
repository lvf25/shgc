...
public:
    ...
    Q_PROPERTY(QmlObjectTableModel*  visualItems             READ visualItems                NOTIFY visualItemsChanged)
...
//    Q_PROPERTY(QStringList          complexMissionItemNames READ complexMissionItemNames    NOTIFY complexMissionItemNamesChanged)
    ...
    Q_PROPERTY(QGeoCoordinate       takeoffCoordinate       READ takeoffCoordinate            NOTIFY takeoffCoordinateChanged)
    ...
    Q_PROPERTY(bool                 locationHomeItem        READ locationHomeItem           NOTIFY locationHomeItemChange)
...
//    Q_PROPERTY(QString              structureScanComplexItemName    READ structureScanComplexItemName   CONSTANT)
    ...
    Q_INVOKABLE bool savefile(QStringList NameFilters);

    Q_INVOKABLE bool loadfile(QStringList NameFilters);


    Q_INVOKABLE void removeMissionItem(int index);
    Q_INVOKABLE void upMissionItem(int index);
    Q_INVOKABLE void downMissionItem(int index);
...
//    /// Sends the mission items to the specified vehicle
    static void sendItemsToVehicle(Vehicle* vehicle, QmlObjectTableModel* visualMissionItems);
...
//    // Property accessors
    ...
    QmlObjectTableModel* visualItems                 (void) { return _visualItems; }
...
//    QString             structureScanComplexItemName(void) const { return patternStructureScanName; }
    ...
    bool    locationHomeItem        (void) const { return _locationHomeItem; }
...
signals:
    ...
    void takeoffCoordinateChanged       (void);

    void sendtovehicle              (int seq);
    void locationHomeItemChange           (void);
...
//    void _complexBoundingBoxChanged();
    ...
    void ChlocationHomeItem(bool str);
...
//    void _setupActiveVehicle(Vehicle* activeVehicle, bool forceLoadFromVehicle);
    ...
    void _addMissionSettings(QmlObjectTableModel* visualItems, bool addToCenter);
//    bool _loadJsonMissionFile(const QByteArray& bytes, QmlObjectTableModel* visualItems, QString& errorString);
//    bool _loadJsonMissionFileV1(const QJsonObject& json, QmlObjectTableModel* visualItems, QString& errorString);
    bool _loadJsonMissionFileV2(const QJsonObject& json, QmlObjectTableModel* visualItems, QString& errorString);
//    bool _loadTextMissionFile(QTextStream& stream, QmlObjectTableModel* visualItems, QString& errorString);
    int _nextSequenceNumber(void);
    void _scanForAdditionalSettings(QmlObjectTableModel* visualItems, Vehicle* vehicle);
    static bool _convertToMissionItems(QmlObjectTableModel* visualMissionItems, QList<MissionItem*>& rgMissionItems, QObject* missionItemParent);
    ...
    bool _loadItemsFromJson(const QJsonObject& json, QmlObjectTableModel* visualItems, QString& errorString);
    void _initLoadedVisualItems(QmlObjectTableModel* loadedVisualItems);
...
private:
    ...
    QmlObjectTableModel*     _visualItems;
