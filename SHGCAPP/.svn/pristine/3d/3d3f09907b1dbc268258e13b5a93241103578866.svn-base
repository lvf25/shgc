...
public:
    ...
    static bool scanStopTakingPhotos(QmlObjectTableModel* visualItems, int scanIndex, bool removeScannedItems);
    static bool scanStopTakingVideo(QmlObjectTableModel* visualItems, int scanIndex, bool removeScannedItems);
    ...
    bool scanForSection     (QmlObjectTableModel* visualItems, int scanIndex) override;
...
private:
    bool _scanGimbal(QmlObjectTableModel* visualItems, int scanIndex);
    bool _scanTakePhoto(QmlObjectTableModel* visualItems, int scanIndex);
    bool _scanTakePhotosIntervalTime(QmlObjectTableModel* visualItems, int scanIndex);
    bool _scanTriggerStartDistance(QmlObjectTableModel* visualItems, int scanIndex);
    bool _scanTriggerStopDistance(QmlObjectTableModel* visualItems, int scanIndex);
    bool _scanTakeVideo(QmlObjectTableModel* visualItems, int scanIndex);
    bool _scanSetCameraMode(QmlObjectTableModel* visualItems, int scanIndex);
