...
{
    qDebug() << "sadadadasddaadaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" << endl;
    if (_parameterMetaData) {
        return;
    }
    ...
    qDebug() << "Loading meta data file:major:minor" << metaDataFile << majorVersion << minorVersion << endl;
...
void ParameterManager::_loadOfflineEditingParams(void)
{
    ...
    qDebug() << "qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq" << _parametersReady << endl;
    _debugCacheCRC.clear();
}
