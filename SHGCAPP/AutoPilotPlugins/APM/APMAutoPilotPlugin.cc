...
{
    qDebug() << "_components.count()" << _components.count() << _incorrectParameterVersion <<endl;
    if (_components.count() == 0 && !_incorrectParameterVersion) {
//        qDebug() << "_vehicle->parameterManager()->parametersReady()" << _vehicle->parameterManager()->parametersReady() << endl;
