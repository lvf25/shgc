...
public:
    ...
    Q_PROPERTY(QQuickItem* progressBar01 MEMBER _progressBar01)
    Q_PROPERTY(QQuickItem* progressBar02 MEMBER _progressBar02)
    Q_PROPERTY(QQuickItem* progressBar03 MEMBER _progressBar03)
...
private:
    ...
    QQuickItem* _progressBar01;
    QQuickItem* _progressBar02;
    QQuickItem* _progressBar03;
