...

{
    ...
    if (_gcsHeartbeatEnabled) {
        qDebug() << "_gcsHeartbeatEnabled" << _gcsHeartbeatEnabled << endl;
...
void MultiVehicleManager::_vehicleHeartbeatInfo(LinkInterface* link, int vehicleId, int componentId, int vehicleFirmwareType, int vehicleType)
{
    ...
    if (componentId != MAV_COMP_ID_AUTOPILOT1) {
        ...
        if (vehicleId != 81 || componentId != 50) {
            ...
            qDebug() << "Ignoring heartbeat from unknown component "
                                              << link->getName()
                                              << vehicleId
                                              << componentId
                                              << vehicleFirmwareType
...
//    vehicle->uas()->shutdownVehicle();
    qDebug() << "ssssssssssssssssssss" << "_deleteVehiclePhase1" << endl;
...
{
    qDebug() << "ssssssssssssssssssss" << "_deleteVehiclePhase2" << endl;
