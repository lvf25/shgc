...
bool CameraSection::_scanGimbal(QmlObjectTableModel* visualItems, int scanIndex)
{
...
bool CameraSection::_scanTakePhoto(QmlObjectTableModel* visualItems, int scanIndex)
{
    if (scanIndex > visualItems->count() -1) {
        return false;
    }
...
bool CameraSection::_scanTakePhotosIntervalTime(QmlObjectTableModel* visualItems, int scanIndex)
{
    if (scanIndex > visualItems->count() -1) {
        return false;
    }
...
bool CameraSection::scanStopTakingPhotos(QmlObjectTableModel* visualItems, int scanIndex, bool removeScannedItems)
{
...
bool CameraSection::_scanTriggerStartDistance(QmlObjectTableModel* visualItems, int scanIndex)
{
    if (scanIndex < 0 || scanIndex > visualItems->count() -1) {
        return false;
    }
...
bool CameraSection::_scanTriggerStopDistance(QmlObjectTableModel* visualItems, int scanIndex)
{
    if (scanIndex < 0 || scanIndex > visualItems->count() -1) {
        return false;
    }
...
bool CameraSection::_scanTakeVideo(QmlObjectTableModel* visualItems, int scanIndex)
{
    if (scanIndex > visualItems->count() -1) {
        return false;
    }
...
bool CameraSection::scanStopTakingVideo(QmlObjectTableModel* visualItems, int scanIndex, bool removeScannedItems)
{
    if (scanIndex < 0 || scanIndex > visualItems->count() -1) {
        return false;
    }
...
bool CameraSection::_scanSetCameraMode(QmlObjectTableModel* visualItems, int scanIndex)
{
    if (scanIndex < 0 || scanIndex > visualItems->count() -1) {
        return false;
    }
...
bool CameraSection::scanForSection(QmlObjectTableModel* visualItems, int scanIndex)
{
